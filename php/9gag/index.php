...
<!--
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
          ...
          <form method="GET" action="procesar.php">
            <table>
              <tr>
                <td>Código: <input id="txt-codigo" name="txt-codigo" type="text" class="form-control"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <tr>
                  <td>
                    ...
                    <input style="display: none;" id="btn-actualizar" type="button" value="Actualizar" class="btn btn-success" onclick="">
                    <input style="display: none;" id="btn-cancelar" type="button" value="Cancelar" class="btn btn-danger" onclick="">
